"""Native cognis-connect emit for waybackrecon — forward findings to any platform.

Maps waybackrecon's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    waybackrecon ... --format json | waybackrecon-emit --to stix
    waybackrecon-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
