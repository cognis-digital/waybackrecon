"""WAYBACKRECON command-line interface."""
from __future__ import annotations
import argparse, sys
from waybackrecon.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="waybackrecon", description="WAYBACKRECON — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from waybackrecon.mcp_server import serve
        return serve()
    if args.cmd == "scan":
