"""WAYBACKRECON core — Mine archived URLs/params/endpoints from a Wayback/CDX export."""
...
RULES = [
    ("WAY-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("WAY-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("WAY-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
