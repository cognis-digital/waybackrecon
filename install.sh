#!/usr/bin/env sh
# Universal installer for waybackrecon. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/waybackrecon.git"
echo "Installing waybackrecon ..."
...
echo "Done. Run: waybackrecon --help"
